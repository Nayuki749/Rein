...
namespace Rein {
	class Program {
		static void Main(string[] args) {
			Logger.Log("Rein " + Common.PRODUCT_VERSION);
			Logger.Log("--------------------");
		...
		public static void ShowVersions() {
			...
			ShowAssemblyVersion(typeof(Rein.Options.MainConfig));
			ShowAssemblyVersion(typeof(Rein.Plugins.IPlugin));
			ShowAssemblyVersion(typeof(Rein.Utility.Common));
			Logger.DebugLog("--------------------");
		}
