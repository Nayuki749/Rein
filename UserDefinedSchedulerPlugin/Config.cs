...
namespace Rein.UserDefinedSchedulerPlugin {
	[JsonObject("Rein.UserDefinedSchedulerPlugin.UserDefinedSchedulerConfig")]
	public class UserDefinedSchedulerConfig {
		[JsonProperty("dir")]
		public string Dir { get; set; } = "schedules";
	}

	[JsonObject("Rein.UserDefinedSchedulerPlugin.ScheduleConfig")]
