...
using TYPE_OF_SOUND_BINARY_POOL = Rein.Utility.BinaryPool<Rein.Utility.BinaryStream, System.IO.MemoryStream>;

namespace Rein.SoundEffectPlugin {
	public class SoundEffectCommand : IPlugin {
		public string Name { get; } = "Rein.SoundEffectPlugin.SoundEffectCommand";
