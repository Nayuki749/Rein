...
namespace Rein.SoundEffectPlugin {
	public class SoundEffectListCommand : AbstractMentionKeywordCommand {
		public override string Name { get; } = "Rein.SoundEffectPlugin.SoundEffectListCommand";
		...
		public void Reload(IBot bot) {
			var p = bot.GetPlugin("Rein.SoundEffectPlugin.SoundEffectCommand") as SoundEffectCommand;
			if (p == null) {
