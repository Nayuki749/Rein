...
namespace Rein.UserDefinedFilterPlugin {
	public class UserDefinedFilterReloadCommand : AbstractMentionKeywordCommand {
		public override string Name { get; } = "Rein.UserDefinedFilterPlugin.UserDefinedFilterReloadCommand";
		...
		private void LoadPlugin(IBot bot) {
			if (_plg_udf == null) {
				_plg_udf = bot.GetPlugin("Rein.UserDefinedFilterPlugin.UserDefinedFilter") as UserDefinedFilter;
				if (_plg_udf == null) {
