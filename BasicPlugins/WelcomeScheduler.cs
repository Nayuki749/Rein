...
namespace Rein.BasicPlugins {
	...
	[JsonObject("Rein.BasicPlugins.WelcomeSchedulerConfig")]
	...
	[JsonObject("Rein.BasicPlugins.WelcomeSchedulerSingleUserConfig")]
	...
	public class WelcomeScheduler : IPlugin {
		public const string NAME = "Rein.BasicPlugins.WelcomeScheduler";
	...
	public class WelcomeTask : ScheduledTaskBase {
		private const string NAME = "Rein.BasicPlugins.WelcomeTask";
